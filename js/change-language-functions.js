var languageContent = {
    greek: {
      ...
      footerText: "Αυτό το έργο δημιουργήθηκε για τις ανάγκες της εργασίας στο μάθημα Συστήματα Ηλεκτρονικής Διακυβέρνησης από τον μεταπτυχιακό φοιτητή της Εφαρμοσμένης Πληροφορικής: Αντώνη Βλαχάβα",
      and: "και",
