var languageContent = {
    greek: {
      ...
      footerText: "Αυτό το έργο δημιουργήθηκε για τις ανάγκες της εργασίας μου στο μάθημα Συστήματα Ηλεκτρονικής Διακυβέρνησης στο Πανεπιστήμιο Μακεδονίας. Μεταπτυχιακός φοιτητής της Εφαρμοσμένης Πληροφορικής:",
