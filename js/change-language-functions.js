var languageContent = {
    greek: {
      languageBtn: "EL",
      mainTitle: "Αίτηση για Επίδομα Γέννησης",
      pageTitle: "Αίτηση για Επίδομα Γέννησης",
      infoTitle: "Πληροφορίες για την αίτηση για Επίδομα Γέννησης",
      ...
      footerText: "Αυτό το έργο δημιουργήθηκε για τις ανάγκες της εργασίας μου στο μάθημα Συστήματα Ηλεκτρονικής Διακυβέρνησης στο Πανεπιστήμιο Μακεδονίας. Μεταπτυχιακός φοιτητής της Εφαρμοσμένης Πληροφορικής: Βλαχάβας Αντώνης",
      student1: "Βλαχάβας Αντώνης",
