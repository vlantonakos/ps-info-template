var languageContent = {
    greek: {
      ...
      footerText: "Αυτό το έργο δημιουργήθηκε για τις ανάγκες της εργασίας στο μάθημα Συστήματα Ηλεκτρονικής Διακυβέρνησης από τον μεταπτυχιακό φοιτητρή της Εφαρμοσμένης Πληροφορικής: Αντώνη Ραφαήλ Βλαχάβα",
      and: "και",
